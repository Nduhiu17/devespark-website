      ...
      {isMenuOpen && (
        <div className="md:hidden bg-gray-800 shadow-lg py-4 relative z-10"> {/* Changed background color */}
         ...
         <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-green-300 focus:ring-opacity-75"
              title="Chat with us on WhatsApp"
              style={{ boxShadow: '0 4px 16px rgba(16, 185, 129, 0.25)' }}
            >
              <svg
